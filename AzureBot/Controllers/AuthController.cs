...
namespace AzureBot.Controllers
{
    public class AuthController : ApiController
    {
        ...
        {
            ClientId = Environment.GetEnvironmentVariable("ARM_API_CLIENTID");
            ClientSecret = Environment.GetEnvironmentVariable("ARM_API_CLIENTSECRET");
        ...
        {
            UriBuilder uri = new UriBuilder("https://login.microsoftonline.com/9c313d7e-ffdb-41dd-8d7b-ba418b6103ec/oauth2/authorize");
        ...
        {
            UriBuilder uriBuilder = new UriBuilder("https://login.microsoftonline.com/9c313d7e-ffdb-41dd-8d7b-ba418b6103ec/oauth2/token");
            var query = new StringBuilder();
        ...
        public async Task<string> ReceiveToken(string code = null, string state = null)
        {
            if (!string.IsNullOrEmpty(code) && !string.IsNullOrEmpty(state))
            {
                ...
                using (var http = new HttpClient())
                {
                    ...
                    var resp = await http.PostAsync(new Uri("https://login.microsoftonline.com/9c313d7e-ffdb-41dd-8d7b-ba418b6103ec/oauth2/token"), content);
